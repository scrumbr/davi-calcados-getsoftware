 ...
 * @author Andrey Gois
 */
public class SaidaRelatorioGUI extends javax.swing.JFrame {
    ...
    public SaidaRelatorioGUI(TelaMenuGUI telaMenu){
        this();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gerar relatorio de saídas por data");
...
//select  e.id_entrada, e.descricao_entrada, e.valor_entrada, e.data_entrada, u.username from entrada as e, usuario as u where e.id_usuario = u.id_usuario and data_entrada BETWEEN '2014/05/11' AND '2014/05/13';
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SaidaRelatorioGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SaidaRelatorioGUI().setVisible(true);
            }
        });
    }
