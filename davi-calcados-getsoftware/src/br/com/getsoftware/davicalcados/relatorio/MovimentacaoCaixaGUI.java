 ...
 * @author Andrey Gois
 */
public class MovimentacaoCaixaGUI extends javax.swing.JFrame {
    ...
    public MovimentacaoCaixaGUI(TelaMenuGUI telaMenu){
        this();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gerar relatorio da movimentação do caixapor data");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MovimentacaoCaixaGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MovimentacaoCaixaGUI().setVisible(true);
            }
        });
    }
