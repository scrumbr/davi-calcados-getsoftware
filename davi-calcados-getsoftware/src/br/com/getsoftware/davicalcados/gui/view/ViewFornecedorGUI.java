 ...
 * @author Andrey Gois
 */
public class ViewFornecedorGUI extends javax.swing.JFrame {

    /**
     * Creates new form ViewClienteGUi
     */
    public ViewFornecedorGUI() {
        initComponents();
    }
    ...
    public ViewFornecedorGUI(ListFornecedorGUI listForn, Fornecedor fornecedor){
        this();
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(jLnome, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        setSize(new java.awt.Dimension(621, 536));
    ...
    private void jLeditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLeditarMouseClicked
        ...
        try {
            new EditFornecedorGUI(listForn, fornecedor).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewFornecedorGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewFornecedorGUI().setVisible(true);
            }
        });
    }
...
public void refreshCampos() {
        ...
        jLcpf.setText(fornecedor.getFisicaJuridica());
        jLemail.setText(fornecedor.getEmail());
        jLtel.setText(fornecedor.getTelefone());
        jLtel2.setText(fornecedor.getTelefone2());        
        jTObservacao.setText(fornecedor.getObservacao());
       
        jLbairro.setText(fornecedor.getEndereco().getBairro());
        jLcep.setText(fornecedor.getEndereco().getCEP());
        jLcidade.setText(fornecedor.getEndereco().getCidade());
        jLcomplento.setText(fornecedor.getEndereco().getComplemento());
        jLestado.setText(fornecedor.getEndereco().getEstado());
        jLnum.setText("" + fornecedor.getEndereco().getNumero());
        jLrua.setText(fornecedor.getEndereco().getRua());
    }
