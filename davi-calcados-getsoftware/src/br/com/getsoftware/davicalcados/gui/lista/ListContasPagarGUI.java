...
public class ListContasPagarGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/getsoftware/davicalcados/icons/quitar-24.png"))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DESCRIÇÃO", "DATA", "VALOR", "STATUS"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Long.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Boolean.class
            };
    ...
    private void jBEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEditarActionPerformed
        this.setEnabled(false);
        new EditContasPagar(this).setVisible(true);
    ...
    public void dadosTabela() throws SQLException {
        ...
        for (int i = 0; i < listContasPagar.size(); i++) {
            modelo.addRow(new Object[]{
                ...
                listContasPagar.get(i).getDataPagamento(),
                listContasPagar.get(i).getValor(),
