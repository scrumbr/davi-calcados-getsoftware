 ...
 * @author Andrey Gois
 */
public class ListContasReceberGUI extends javax.swing.JFrame {

    TelaMenuGUI telaMenu;
    
    public ListContasReceberGUI() {
        initComponents();
    }

    public ListContasReceberGUI(TelaMenuGUI telaMenu){
        this();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lista contas á receber");
        ...
        jBCadastrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/getsoftware/davicalcados/icons/contasReceber-24.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(917, 553));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListContasReceberGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListContasReceberGUI().setVisible(true);
            }
        });
    }
